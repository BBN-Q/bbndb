"""2019.2 Updated Schema

Revision ID: dc9546bb9eb1
Revises: 42ecd9b813c8
Create Date: 2019-10-28 22:08:29.691017
...
revision = 'dc9546bb9eb1'
down_revision = '42ecd9b813c8'
branch_labels = None
depends_on = None
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('transmitter', sa.Column('delay', sa.FLOAT(), server_default="0.0", nullable=False))
